...
public class RegisterBlocksAndItems {
	...
	public static void init() {
		Registry.register(BuiltInRegistries.BLOCK, TrailierTalesSharedConstants.id("suspicious_red_sand"), SUSPICIOUS_RED_SAND);
		Registry.register(BuiltInRegistries.ITEM, TrailierTalesSharedConstants.id("suspicious_red_sand"), SUSPICIOUS_RED_SAND_ITEM);
		...
		Registry.register(BuiltInRegistries.BLOCK, TrailierTalesSharedConstants.id("suspicious_dirt"), SUSPICIOUS_DIRT);
		Registry.register(BuiltInRegistries.ITEM, TrailierTalesSharedConstants.id("suspicious_dirt"), SUSPICIOUS_DIRT_ITEM);
		ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.FUNCTIONAL_BLOCKS).register(entries ->
		...
		Registry.register(BuiltInRegistries.BLOCK, TrailierTalesSharedConstants.id("suspicious_clay"), SUSPICIOUS_CLAY);
		Registry.register(BuiltInRegistries.ITEM, TrailierTalesSharedConstants.id("suspicious_clay"), SUSPICIOUS_CLAY_ITEM);
		ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.FUNCTIONAL_BLOCKS).register(entries ->
