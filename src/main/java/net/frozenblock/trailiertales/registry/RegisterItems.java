...
public class RegisterItems {
	public static final Item ECTOPLASM = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	...
	public static final Item BAIT_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item BLOOM_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item BULLSEYE_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item CRESCENT_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item CULTIVATOR_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item ESSENCE_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item EYE_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item INCIDENCE_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item LUMBER_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item NEEDLES_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item PROTECTION_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item SHINE_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item SHOWER_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item SPADE_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	public static final Item WITHER_POTTERY_SHERD = new Item(new Item.Properties().requiredFeatures(TrailierFeatureFlags.TRAILIER_TALES));
	...
	public static final Item DESOLATION_ARMOR_TRIM_SMITHING_TEMPLATE = SmithingTemplateItem.createArmorTrimTemplate(
		...
		TrailierFeatureFlags.TRAILIER_TALES
	);
