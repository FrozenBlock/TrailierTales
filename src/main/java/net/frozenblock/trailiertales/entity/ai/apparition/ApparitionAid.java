...
public class ApparitionAid extends Behavior<Apparition> {
	...
	@Override
	protected boolean checkExtraStartConditions(ServerLevel level, @NotNull Apparition apparition) {
	...
	@Override
	protected void start(ServerLevel level, @NotNull Apparition apparition, long l) {
		final Brain<Apparition> brain = apparition.getBrain();
	...
	@Override
	protected void stop(ServerLevel level, @NotNull Apparition apparition, long l) {
		final Brain<Apparition> brain = apparition.getBrain();
