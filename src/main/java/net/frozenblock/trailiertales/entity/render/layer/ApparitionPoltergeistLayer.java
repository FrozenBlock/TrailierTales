...
public class ApparitionPoltergeistLayer extends RenderLayer<Apparition, ApparitionModel<Apparition>> {
	private static final RenderType TEXTURE = FrozenRenderType.apparitionOuter(TrailierConstants.id("textures/entity/apparition/apparition_aggressive.png"));
	private final ApparitionModel<Apparition> model;

	public ApparitionPoltergeistLayer(EntityRendererProvider.@NotNull Context context, RenderLayerParent<Apparition, ApparitionModel<Apparition>> renderLayerParent) {
