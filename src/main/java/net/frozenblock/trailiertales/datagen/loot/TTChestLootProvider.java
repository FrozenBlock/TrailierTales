			...
			LootTable.lootTable()
				...
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(Items.IRON_CHAIN).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1, 2))))
					...
					LootPool.lootPool()
						...
						.add(
							LootItem.lootTableItem(Items.OMINOUS_BOTTLE)
								.setWeight(1)
								.apply(SetItemCountFunction.setCount(ConstantValue.exactly(1F)))
								.apply(SetOminousBottleAmplifierFunction.setAmplifier(UniformGenerator.between(1F, 3F)))
						)
