		...
		Pools.register(
			...
			new StructureTemplatePool(
				...
				List.of(
					...
					Pair.of(StructurePoolElement.single(string("tomb/two_coffins1"), catacombsDegradation), 2),
					Pair.of(StructurePoolElement.single(string("tomb/caged_chest"), catacombsDegradation), 2),
					Pair.of(StructurePoolElement.single(string("tomb/two_chest_doors"), catacombsDegradation), 2),
					Pair.of(StructurePoolElement.single(string("tomb/small_fancy_tomb"), catacombsDegradation), 2),
