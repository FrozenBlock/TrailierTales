		...
		ImmutableList.of(
			...
			new RuleProcessor(
				ImmutableList.of(
					...
					TTStructures.archyProcessorRule(Blocks.RED_SAND, TTBlocks.SUSPICIOUS_RED_SAND.get(), TTLootTables.BADLANDS_RUINS_ARCHAEOLOGY, 0.1F),
			...
			TTStructures.decoratedPotSherdProcessor(
				1F,
				TTItems.SHED_POTTERY_SHERD.get(),
				Items.BURN_POTTERY_SHERD,
				TTItems.WITHER_POTTERY_SHERD.get(),
				TTItems.DROUGHT_POTTERY_SHERD.get()
			)
		)
	);
