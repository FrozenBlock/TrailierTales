...
public final class GenericRuinsGenerator {
	...
	public static final StructureProcessorList PROCESSORS = new StructureProcessorList(
		ImmutableList.of(
			...
			TTStructures.archyLootProcessor(Blocks.DIRT, TTBlocks.SUSPICIOUS_DIRT.get(), TTLootTables.RUINS_ARCHAEOLOGY, 0.05F),
			TTStructures.archyLootProcessor(Blocks.COARSE_DIRT, TTBlocks.SUSPICIOUS_DIRT.get(), TTLootTables.RUINS_ARCHAEOLOGY, 0.05F),
			TTStructures.archyLootProcessor(Blocks.CLAY, TTBlocks.SUSPICIOUS_CLAY.get(), TTLootTables.RUINS_ARCHAEOLOGY, 0.4F),
			TTStructures.decoratedPotSherdProcessor(
				1F,
				TTItems.LUMBER_POTTERY_SHERD.get(),
				Items.ARCHER_POTTERY_SHERD,
				Items.BLADE_POTTERY_SHERD,
				TTItems.SPROUT_POTTERY_SHERD.get()
			)
		)
	);
