...
public class JungleRuinsGenerator {
	...
	public static final StructureProcessorList PROCESSORS = new StructureProcessorList(
		ImmutableList.of(
			...
			TTStructures.archyLootProcessor(Blocks.DIRT, TTBlocks.SUSPICIOUS_DIRT.get(), TTLootTables.JUNGLE_RUINS_ARCHAEOLOGY, 0.05F),
			TTStructures.archyLootProcessor(Blocks.COARSE_DIRT, TTBlocks.SUSPICIOUS_DIRT.get(), TTLootTables.JUNGLE_RUINS_ARCHAEOLOGY, 0.05F),
			TTStructures.archyLootProcessor(Blocks.CLAY, TTBlocks.SUSPICIOUS_CLAY.get(), TTLootTables.JUNGLE_RUINS_ARCHAEOLOGY, 0.4F),
			TTStructures.decoratedPotSherdProcessor(
				1F,
				TTItems.BOLT_POTTERY_SHERD.get(),
				TTItems.NAVIGATOR_POTTERY_SHERD.get(),
				TTItems.BLOOM_POTTERY_SHERD.get(),
				TTItems.SHOWER_POTTERY_SHERD.get()
			)
		)
	);
}
