...
public final class DesertRuinsGenerator {
	...
	public static final StructureProcessorList PROCESSORS = new StructureProcessorList(
		ImmutableList.of(
			...
			TTStructures.archyLootProcessor(Blocks.CLAY, TTBlocks.SUSPICIOUS_CLAY.get(), TTLootTables.DESERT_RUINS_ARCHAEOLOGY, 0.3F),
			new RuleProcessor(
				ImmutableList.of(
					new ProcessorRule(
			...
			TTStructures.decoratedPotSherdProcessor(
				1F,
				TTItems.HUMP_POTTERY_SHERD.get(),
				TTItems.NEEDLES_POTTERY_SHERD.get(),
				Items.DANGER_POTTERY_SHERD,
				TTItems.SHINE_POTTERY_SHERD.get()
			)
		)
	);
