...
public class ApparitionSpecificSensor extends Sensor<LivingEntity> {
	...
	public Set<MemoryModuleType<?>> requires() {
		return ImmutableSet.of(TTMemoryModuleTypes.NEARBY_APPARITIONS.get(), MemoryModuleType.NEAREST_LIVING_ENTITIES);
	}
	...
	protected void doTick(ServerLevel level, LivingEntity entity) {
		...
		brain.setMemory(TTMemoryModuleTypes.NEARBY_APPARITIONS.get(), apparitions);
	}
}
