			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(TTItems.OMEN_POTTERY_SHERD.get()).setWeight(2))
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(TTItems.ESSENCE_POTTERY_SHERD.get()).setWeight(2))
						.add(LootItem.lootTableItem(TTItems.EYE_POTTERY_SHERD.get()).setWeight(2))
						.add(LootItem.lootTableItem(TTItems.BULLSEYE_POTTERY_SHERD.get()).setWeight(2))
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(TTItems.HUMP_POTTERY_SHERD.get()).setWeight(6))
						.add(LootItem.lootTableItem(TTItems.NEEDLES_POTTERY_SHERD.get()).setWeight(6))
						.add(LootItem.lootTableItem(Items.DANGER_POTTERY_SHERD).setWeight(6))
						.add(LootItem.lootTableItem(TTItems.SHINE_POTTERY_SHERD.get()).setWeight(6))
						.add(LootItem.lootTableItem(TTItems.ZEPHYR_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(4))
				)
		);
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(TTItems.BOLT_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.NAVIGATOR_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.BLOOM_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.SHOWER_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.OVERGROWTH_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(5))
				)
		);
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(TTItems.CRAWL_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.CLUCK_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.PLUME_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(Items.SHELTER_POTTERY_SHERD).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.COT_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(5))
				)
		);
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(TTItems.LUMBER_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.CULTIVATOR_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.SPROUT_POTTERY_SHERD.get()).setWeight(7))
				)
		);
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(TTItems.AURORA_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.ENCLOSURE_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.HARE_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.FROST_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.EMBRACE_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(5))
				)
		);
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(TTItems.HEIGHT_POTTERY_SHERD.get()).setWeight(7))
						.add(LootItem.lootTableItem(TTItems.GEODE_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(5))
				)
		);
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(TTItems.SHED_POTTERY_SHERD.get()).setWeight(6))
						.add(LootItem.lootTableItem(Items.BURN_POTTERY_SHERD).setWeight(6))
						.add(LootItem.lootTableItem(TTItems.WITHER_POTTERY_SHERD.get()).setWeight(6))
						.add(LootItem.lootTableItem(TTItems.DROUGHT_POTTERY_SHERD.get()).setWeight(6))
						.add(LootItem.lootTableItem(TTItems.MARTYR_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(4))
				)
		);
	}
}
